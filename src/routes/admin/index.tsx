      ...
      >
        ...
        >
          <div className="mb-10 text-center">
            ...
            <h1 className="font-display mb-2" style={{ fontSize: "clamp(28px, 5vw, 40px)", letterSpacing: "-0.02em" }}>
              Platform Admin
            </h1>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            <div>
              ...
              <div className="relative">
                <Key className="absolute left-4 top-1/2 -translate-y-1/2" size={18} style={{ color: "var(--text-muted)" }} />
                <input
                  type="password"
                  value={masterKey}
